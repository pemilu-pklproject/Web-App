              ...
              <div className="row">
                <div className="col-8">
                  <div className="numbers">
                    ...
                    <p className="mb-0">
                      <span className="text-success text-sm font-weight-bolder">+55%</span> since yesterday
                    </p>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-8">
                  <div className="numbers">
                    ...
                    <p className="mb-0">
                      <span className="text-success text-sm font-weight-bolder">+3%</span> since last week
                    </p>
                  </div>
                </div>
                <div className="col-4 text-end">
              ...
              <div className="row">
                <div className="col-8">
                  <div className="numbers">
                    ...
                    <p className="mb-0">
                      <span className="text-danger text-sm font-weight-bolder">-2%</span> since last quarter
                    </p>
                  </div>
                </div>
                <div className="col-4 text-end">
